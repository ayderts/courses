...
{
    private const TABLE_NAME = 'group_student';
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Группа-слушатель',
            'display_name_plural' => 'Группа-слушатели',
            'icon' => 'voyager-people',
            'model_name' => 'App\\Models\\GroupStudent',
            'controller' => '',
        ...
        DataRow::create([
            'data_type_id' => $dataType->id,
            'field' => 'listeners_belongstomany_group_students_relationship',
            'type' => 'relationship',
            ...
            'delete' => 1,
            'details' => [
                'model' => 'App\\Models\\CourseListeners',
                'table' => 'course_listeners',
                'type' => 'belongsToMany',
                'column' => 'id',
                'key' => 'id',
                'label' => 'full_name',
                'pivot_table' => 'ref_listeners_group_students',
                'pivot' => '1',
                'taggable' => '0',
            ],
        ]);
