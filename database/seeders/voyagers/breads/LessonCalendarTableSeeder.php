...
class LessonCalendarTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Календарь занятий',
            'display_name_plural' => 'Календарь занятий',
            'icon' => 'voyager-alarm-clock',
            'model_name' => 'App\\Models\\LessonCalendar',
            'controller' => '',
        ...
        DataRow::create([
            ...
            'display_name' => 'Тип (онлайн, оффлайн, смешанный)',
            'required' => 1,
            'browse' => 1,
            'read' => 1,
            'edit' => 1,
