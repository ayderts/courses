...
class LessonLinkTableSeeder extends Seeder
{
    private const TABLE_NAME = 'lesson_links';
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Ссылка на урок',
            'display_name_plural' => 'Ссылки на уроки',
            'icon' => 'voyager-external',
            'model_name' => 'App\\Models\\LessonLink',
            'controller' => '',
