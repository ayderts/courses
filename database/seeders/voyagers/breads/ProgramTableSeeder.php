...
class ProgramTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DataRow::create([
            'data_type_id' => $dataType->id,
            'field' => 'handbook_year_id',
            'type' => 'number',
            'display_name' => 'Справочник: год',
            'required' => 0,
            'browse' => 0,
            'read' => 1,
            'edit' => 1,
        ...
        DataRow::create([
            'data_type_id' => $dataType->id,
            'field' => 'handbook_year_id_relationship',
            'type' => 'relationship',
            'display_name' => 'Справочник: год',
            'required' => 0,
            'browse' => 0,
            ...
            'delete' => 1,
            'details' => [
                'model' => 'App\\Models\\HandbookYear',
                'table' => 'handbook_years',
                'type' => 'belongsTo',
                'column' => 'handbook_year_id',
                'key' => 'id',
                'label' => 'name',
                'pivot_table' => 'migrations',
                'pivot' => '0',
