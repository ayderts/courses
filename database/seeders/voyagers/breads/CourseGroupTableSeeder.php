...
class CourseGroupTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Группы обучения',
            'display_name_plural' => 'Группы обучения',
            'icon' => 'voyager-window-list',
            'model_name' => 'App\\Models\\CourseGroup',
            'controller' => '',
        ...
        DataRow::create([
            ...
            'type' => 'number',
            'display_name' => 'Максимальное кол-во слушателей',
            'required' => 1,
            'browse' => 1,
            'read' => 1,
            'edit' => 1,
        ...
        DataRow::create([
            'data_type_id' => $dataType->id,
            'field' => 'belongs_to_many_user_id_relationship',
            'type' => 'relationship',
            'display_name' => 'Слушатели',
            'required' => 0,
            'browse' => 1,
            'read' => 1,
            'edit' => 1,
            ...
            'details' => [
                ...
                'key' => 'id',
                'label' => 'name',
                'pivot_table' => 'course_group_student',
                'pivot' => '1',
            ],
        ]);
        ...
        DataRow::create([
            ...
            'field' => 'active',
            'type' => 'checkbox',
            'display_name' => 'Активность (да/нет)',
            'required' => 1,
            'browse' => 1,
            'read' => 1,
            'edit' => 1,
