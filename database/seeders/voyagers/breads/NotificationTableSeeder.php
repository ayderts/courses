...
class NotificationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Уведомление',
            'display_name_plural' => 'Уведомления',
            'icon' => 'voyager-chat',
        ...
        DataRow::create([
            ...
            'delete' => 1,
            'details' => [
                'default' => NotificationConstant::SURVEY,
                'options' => NotificationConstant::NOTIFICATION_TYPE,
            ]
        ]);
        ...
        DataRow::create([
            ...
            'field' => 'is_read',
            'type' => 'checkbox',
            'display_name' => 'Статус уведомления(прочитан)',
            'required' => 1,
            'browse' => 1,
            'read' => 1,
            'edit' => 1,
