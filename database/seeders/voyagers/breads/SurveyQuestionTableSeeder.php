...
{
    private const TABLE_NAME = 'survey_questions';
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Вопрос опроса',
            'display_name_plural' => 'Вопросы опроса',
            'icon' => 'voyager-chat',
            'model_name' => 'App\\Models\\SurveyQuestion',
            'controller' => '',
        ...
        DataRow::create([
            ...
            'delete' => 1,
            'details' => [
                'default' => QuestionConstant::RATING,
                'options' => QuestionConstant::QUESTION_TYPE,
            ]
        ]);
