...
class HandbookLibraryAuthorTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Справочник: Библиотека-автор',
            'display_name_plural' => 'Справочник: Библиотека-авторы',
            'icon' => 'voyager-book',
            'model_name' => 'App\\Models\\HandbookLibraryAuthor',
            'controller' => '',
