...
class MaterialTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $dataType = DataType::create([
            ...
            'display_name_singular' => 'Материал урока',
            'display_name_plural' => 'Материалы урока',
        ...
        DataRow::create([
            ...
            'delete' => 1,
            'details' => [
                'default' => FileTypeConstant::REQUIRED,
                'options' => FileTypeConstant::FILE_TYPES,
            ],
        ]);
