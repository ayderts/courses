...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="voyager-tree"></i>{{ $dataType->display_name_plural }}
        </h1>
        <a href="{{ route('voyager.'.$dataType->slug.'.index', ['type' => 'list']) }}" class="btn btn-warning">
            <i class="voyager-window-list"></i> <span>{{ __('voyager::generic.list_view') }}</span>
        </a>
