...
return [
    ...
    */
    'resources' => [
        ...
        'authenticates' => App\Models\Authenticate::class,
        'location-cities' => App\Models\LocationCity::class,
        'location-countries' => App\Models\LocationCountry::class,
        'roles' => \TCG\Voyager\Models\Role::class,
        'response-messages' => App\Models\ResponseMessage::class,
        'courses' => App\Models\Course::class,
        'handbook-direction-types' => App\Models\HandbookDirectionType::class,
        'constants' => App\Models\Constant::class,
        'course-programs' => App\Models\CourseProgram::class,
        'lessons' => App\Models\Lesson::class,
        'materials' => App\Models\Material::class,
        'homeworks' => App\Models\Homework::class,
        'homework-answers' => App\Models\HomeworkAnswer::class,
        'homework-answer-files' => App\Models\HomeworkAnswerFile::class,
    ],
